    ...
    <div className="relative h-screen">
      ...
      <div className="flex flex-col justify-center items-center text-white relative z-10 h-full">
        <div className="flex flex-col gap-6 p-8 max-w-6xl mx-auto text-center">
          ...
          <Link
            to={"/search"}
            className="m-0 p-0 flex items-center justify-center bg-white py-3 px-6 rounded-full text-white text-xl font-bold transition-transform duration-300 ease-in-out bg-opacity-40 hover:text-white mx-auto hover:bg-white hover:scale-110 hover:bg-opacity-40"
          >
            Get Started!!
            <HiMiniArrowRightCircle className="text-3xl mx-0.5" />
          </Link>
        </div>
      </div>
